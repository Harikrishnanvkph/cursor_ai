    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <main className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Presets Action Card */}
          <Link href="/admin/presets" className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900 to-gray-900/50 border border-white/5 p-6 hover:border-violet-500/50 transition-all duration-300 block">
            ...
            <div className="relative">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Manage Presets</h3>
              <p className="text-sm text-gray-400">
                View, edit, toggle official status, or delete reusable chart style presets.
              </p>
              <div className="mt-6 flex items-center text-sm font-medium text-violet-400 group-hover:text-violet-300">
                Open Presets
                <svg className="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                </svg>
