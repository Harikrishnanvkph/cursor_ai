    ...
    <div className="flex h-screen w-screen flex-col items-center justify-center bg-[#FAFAFA]">
      <div className="flex flex-col items-center gap-6">
        ...
        <div className="flex flex-col items-center gap-1.5">
          <h3 className="text-base font-semibold text-gray-900 tracking-tight">Setting up Editor</h3>
          <p className="text-sm font-medium text-gray-500 animate-pulse">Loading engine...</p>
        </div>
      </div>
    </div>
  );
