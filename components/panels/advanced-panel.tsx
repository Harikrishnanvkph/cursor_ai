    ...
    <div className="space-y-2">
      ...
      <div className="space-y-2">
        ...
        <div className="bg-green-50 rounded-lg">
          ...
          {tooltipOpen && (
            <div className={`px-3 pb-3 space-y-2 ${chartConfig.plugins?.tooltip?.enabled === false ? 'opacity-50 pointer-events-none' : ''}`}>
      ...
      <div className="space-y-2">
        ...
        >
          ...
          <h3 className="text-sm font-semibold text-gray-900 flex items-center gap-2 flex-1">
